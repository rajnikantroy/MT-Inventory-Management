...
public partial class ForgetPassword : System.Web.UI.Page
{
    ...
    protected void LinkButton9_Click(object sender, EventArgs e)
    {
        try
        {
            string query = "select emailid, password, quesption, answer from userrecoverypass where emailid='" + TextBox1.Text + "'";
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
            ...
            string query1 = "select password from userrecoverypass where emailid='" + TextBox1.Text + "' and answer ='" + TextBox2.Text + "'";
