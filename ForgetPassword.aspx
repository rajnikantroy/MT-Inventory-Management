<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Home.master" CodeFile="ForgetPassword.aspx.cs" Inherits="ForgetPassword" %>
...
<tr>
<td colspan="2">
   <center> <asp:Label ID="Label4" runat="server" Font-Bold="True"></asp:Label> </center>
</td>
</tr>
<tr width="100%">
<td width="30%">
